...
<p align="center"><img src="images/Fig05.png" alt="Import CSV file"/><br/><sub>Sheet 'Simulate': Press 'Start simulation' button. The most important output files are listed with hyperlinks. Here is shown hypetlink for opening.csv time series in Excel</sub></p>
<p align="center"><img src="images/Fig06.png" alt="View DXF file"/><br/><sub>Sheet 'Simulate': Hyperlink for viewing 3D model (.DXF file)</sub></p>
